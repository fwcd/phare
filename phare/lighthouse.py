...
from phare.serialize import Serializable, serialize
...
class Lighthouse:
    ...
    async def send_message(self, message: ClientMessage[Serializable]):
        binary: bytes = msgpack.packb(serialize(message)) # type: ignore
